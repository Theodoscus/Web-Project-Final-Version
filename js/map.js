  ...
  for (var i = 0; i < data.length; i++)
  {
    ...
    if (has_offers==1){
      ...
      if (circle.getBounds().contains(marker.getLatLng())){
        ...
        marker.bindPopup("Όνομα supermarket: " + name + "<br> Διεύθυνση supermarket: " + address + "<br> <a href="+button1+id+"> Δείτε τις προσφορές!</a> <br> <a href="+button2+id+">Δημιουργήστε μια καινούργια προσφορά!</a>");
      ...
      if (circle.getBounds().contains(marker.getLatLng())){
        marker.bindPopup("Όνομα supermarket: " + name + "<br> Διεύθυνση supermarket: " + address + "<br> Δεν υπάρχουν διαθέσιμες προσφορές! <br> <a href="+button1+id+">Δημιουργήστε μια καινούργια προσφορά!</a>");
      } else {
